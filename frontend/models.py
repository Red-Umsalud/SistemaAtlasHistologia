...
class Ficha(models.Model):
    ...
    id_subelemento = models.ForeignKey('Subelemento', models.DO_NOTHING, db_column='id_subelemento', blank=True, null=True)
...
class Subelemento(models.Model):
    id_subelemento = models.AutoField(primary_key=True)
