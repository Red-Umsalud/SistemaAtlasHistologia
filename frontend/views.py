...
DIC = {
    ...
    'lista_aparatos': {
        ...
        'Digestivo': [
            ...
            ('Encía',118),
            ('Lengua',119),
            ('Lengua. Van Gieson',120),
            ('Diente descalcificado',121),
            ('Odontogénesis',122),
            ('Glándula parótida',123),
            ('Glándula submaxilar',124),
            ('Glándula sublingual',125),
        ],
        'Urinario': [
            ('Riñón',126),
            ('Riñón. Médula',127),
            ('Riñón. Corpúsculo renal',128),
            ('Pelvis renal',129),
            ('Pelvis renal, Mallory',130),
            ('Uréter',131),
            ('Uréter. Mallory',132),
            ('Vejiga',133),
            ('Vejiga. Mallory',134),
        ...
        'Reproductor Femenino': [
            ('Ovario',135),
            ('Ovario. Folículo secundario',136),
            ('Cuerpo albicans',137),
            ('Trompra uterina',138),
            ('Endometrio proliferativo',139),
            ('Endometrio secretor temprano',140),
            ('Cuello uterino. Zona de transición',141),
            ('Endocervix',142),
            ('Vagina',143),
            ('Placenta',144),
        ],
        'Reproductor Masculino': [
            ('Testículo',145),
            ('Testículo. Células de Leydig',146),
            ('Epidídimo',147),
            ('Epidídimo. Mallory',148),
            ('Conducto deferente',149),
            ('Conducto deferente. Van Gieson',150),
            ('Vesícula seminal',151),
            ('Próstata',152),
            ('Pene',153),
            ('Pene. Cuerpo esponjoso',154),
        ]
    },
    'lista_sentidos_especiales': {
        'Ojo': [
            ...
            ('Córnea',156),
            ('Cuerpo ciliar',157),
            ('Retina. Coroides. Esclerótica',158),
            ('Cristalino',159),
        ],
        'Oido': [
            ('Órgano de Corti',160),
            ('Pabellón de oreja',161),
        ]
    }
}
